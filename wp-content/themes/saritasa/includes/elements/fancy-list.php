...
if (class_exists('WPBakeryShortCode')) {
    class WPBakeryShortCode_fancy_ul extends WPBakeryShortCode
    {
    }
}

function sar_fancy_list()
{
    ...
    return [
        ...
        "params" => [
            ...
            [
                ...
                "dependency" => ['element' => "icon_type", 'value' => ['font_icon']],
            ],
            [
                "type" => "dropdown",
                ...
                "dependency" => ['element' => "icon_type", 'value' => ['font_icon', 'standard_dash']],
            ...
            [
                ...
                "admin_label" => false,
                "description" => "",
                "dependency" => ['element' => "enable_animation", 'not_empty' => true],
            ],
        ...
        //"html_template" => SAR_TEMPLATES . '/elements/fancy_list.php'
    ];
}

if (function_exists('vc_lean_map')) {
    add_action('vc_before_init', function () {
        vc_lean_map('fancy-ul', 'sar_fancy_list');
    });
}


add_shortcode('fancy-ul', function ($atts, $content = null) {
    extract(shortcode_atts(['color' => 'Accent-Color', 'alignment' => 'left', 'icon_type' => 'standard_dash', 'icon' => 'icon-glass', 'enable_animation' => 'false', 'delay' => ''], $atts));
