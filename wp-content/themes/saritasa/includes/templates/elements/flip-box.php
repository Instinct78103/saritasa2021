...
$output = '
            <div class="flip-box">
                <div class="flip-box-inner">
                    <div class="flip-box-front" style="' . $style . '">
                        <div class="inner">' . $icon_markup . $front_content . '</div>
                    </div>
                    <div class="flip-box-back" style="' . $style2 . '">
                        <div class="inner">' . wpb_js_remove_wpautop(do_shortcode($content), true) . '</div>
                    </div>
                </div>
            </div>';
